...
def noise_trading_posting_quotes(tt, fundamental_value, phi, kappa, alfa, aux_p1, rng):
    """
...
def nt_quote_wrapper(round_number, fundamental_value, aux_S, num_rounds, market, rng):
